...
namespace API.dal.migrations
{
    ...
    [Migration("20240518113616_Publications_and_document_added")]
    partial class Publications_and_document_added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.DAL.Entities.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "bbcc8aba-1904-4e74-842e-df65e732d212",
                            Name = "Student",
                            NormalizedName = "STUDENT"
                        },
                        new
                        {
                            Id = "74d7131e-48f0-4775-baac-4a366bb64132",
                            Name = "Teacher",
                            NormalizedName = "TEACHER"
                        },
                        new
                        {
                            Id = "5ec2a705-ed95-41ad-8cc2-abdf25dea9df",
                            Name = "Administrator",
            ...
            modelBuilder.Entity("API.DAL.Entities.Document", b =>
                {
                    b.HasOne("API.DAL.Entities.Publication", "Publication")
                        .WithMany("Documents")
